...
public class DoctorList extends JFrame implements ActionListener {
	...
	public void DisplayDoctor()
	{
		...
		conn.close();
			...
			JOptionPane.showConfirmDialog(null, "Name Already exit.Add or Not" , "Name Add Or Not", JOptionPane.WARNING_MESSAGE,JOptionPane.OK_CANCEL_OPTION);
			...
			/*_____________________Check Duplication________________*/
			 ...
			 try{			 
					...
					con = DriverManager.getConnection(url, username, password);
					 ...
					 if(r.next()){
						 int choice=JOptionPane.showConfirmDialog(null, "Name Already exit.Add or Not" , "Name Add Or Not", JOptionPane.WARNING_MESSAGE,JOptionPane.OK_CANCEL_OPTION);
						 ...
						 if(choice==JOptionPane.OK_OPTION){
								...
								Connection conn;
								Statement stmt;									  	
								String query = "INSERT INTO DoctorRecord VALUES ('"+name.getText()+"','"+(String)com.getSelectedItem()+"','"+confee.getText()+"','"+contact.getText()+"','"+address.getText()+"')";			 
								try{			 
									Class.forName("com.mysql.jdbc.Driver");
									conn = DriverManager.getConnection(url, username, password);
									 stmt = conn.createStatement();
